...
- A Current Update is a dated, independently approved, source-backed record associated with a Topic and, where applicable, its Briefing. It shows its effective date and Sources to readers, and never changes the evergreen Briefing's review date by implication. Corrections and supersessions retain an auditable history rather than silently rewriting a published update; see [ADR 0007](../adr/0007-current-updates-as-dated-evidence.md).
