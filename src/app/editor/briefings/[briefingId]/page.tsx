...
import { transitionBriefingAction, acceptEditorialSourceAction, createCurrentUpdateAction, createEditorialClaimAction, transitionCurrentUpdateAction } from "./actions";
...
export default async function BriefingReviewPage({
  ...
  return <BriefingReview editor={editor} review={state.review} transitionAction={transitionBriefingAction.bind(null, briefingId)} sourceAction={acceptEditorialSourceAction.bind(null, briefingId)} claimAction={(sourceId) => createEditorialClaimAction.bind(null, briefingId, state.review.revision.id, sourceId)} currentUpdateAction={createCurrentUpdateAction.bind(null, briefingId)} currentUpdateTransitionAction={(currentUpdateId) => transitionCurrentUpdateAction.bind(null, briefingId, currentUpdateId)} />;
}
